...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="./css/usercorrection2.css">
...
<body>
    ...
    <div class="container">
		...
		<form action="update.do" method="post">
            <div>
                <h3 class="join_title"><label class="btn" for="pswd1">비밀번호</label></h3>
            ...
            <!-- MOBILE -->
            <div>
                <h3 class="join_title"><label class="btn" for="phoneNo">전화번호</label></h3>
            ...
            <!-- EMAIL -->
            <div>
                <h3 class="join_title"><label class="btn" for="email">이메일<span class="optional"></span></label></h3>
